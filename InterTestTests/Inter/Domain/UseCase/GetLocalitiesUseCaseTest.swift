//
//  GetLocalitiesUseCaseTest.swift
//  InterTest
//
...
class GetLocalitiesUseCaseTest: XCTestCase {
    private var sut: GetLocalitiesUseCase!
    ...
    func testGetLocalitiesUseCase_ResponseSuccess() {
        //Given
        let expectationFailure = expectation(description: "failure")
        let expectation = self.expectation(description: "Consume Web Service Response Expectation")
        expectationFailure.isInverted = true
        
        InterRepositoriesStub.responseGetLocalities = TestDomainConstants.localitiesResponse
    ...
    func testGetLocalitiesUseCase_ResponseError() {
        //Given
        let expectationFailure = expectation(description: "failure")
        let expectation = self.expectation(description: "Consume Web Service Response Expectation")
